...
public class Constant {
	public static final float Screen_Height = 320f;//屏幕高度
	public static final float Screen_Width = 480f;//屏幕宽度
	...
	public static float Cell_Size = Constant.Map_Cell_WIDTH*Constant.Screen_Scale;//
	public static float stateTime;//游戏时间
